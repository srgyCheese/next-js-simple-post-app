...
import { z } from 'zod'
import { useCreatePostMutation } from '@/store/services/post'
...
const CreatePostForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-3'>
      ...
      <button
        type="submit"
        disabled={createPostState.isLoading}
        className={`cursor-pointer bg-gradient-to-r from-indigo-950 to-slate-900 p-4 rounded flex justify-center items-center`}
      >
        {createPostState.isLoading && <div role="status">
